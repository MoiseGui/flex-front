...
export class ProfileService {
  ...
  addProfile(Profile: Profile): Observable<any> {
    ...
    return this.http.post<Profile>(`${this.API}/`, {
      libelle,
      open,
      professeurs,
      filieres, /* events, specialEvents */
  ...
  updateProfile(id: number, profile: Profile): Observable<any> {
    const {libelle, open, professeurs, filieres} = profile;
    return this.http.put<Profile>(`${this.API}/id/${id}`, {libelle, open, professeurs, filieres,}, {headers: this.headers});
  }
