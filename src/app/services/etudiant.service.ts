...
export class EtudiantService {
  ...
  addEtudiant(etudiant: Etudiant): Observable<any> {
    const {nom, prenom, email, cne, filierId} = etudiant;
    return this.http.post(`${this.API}/`, {nom, prenom, email, cne, filierId}, {headers: this.headers});
  }

  updateEtudiant(etudiant: Etudiant): Observable<any> {
    const {nom, prenom, email, cne, filierId} = etudiant;
    return this.http.put(`${this.API}/${etudiant.id}`, {nom, prenom, email, cne, filierId}, {headers: this.headers});
  }
